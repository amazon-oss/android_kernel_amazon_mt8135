...
static const char *const mt_pcm_dl1_lr_switch_function[] = {
	ENUM_TO_STR(LR_NORMAL),
	ENUM_TO_STR(LR_SWAP)
};

static const char *const mt_volume_key_switch_function[] = {
	ENUM_TO_STR(VOLKEY_NORMAL),
	ENUM_TO_STR(VOLKEY_SWAP)
};

static int dl1_lr_switch_get(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
...
static int dl1_lr_switch_set(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_platform *platform = snd_kcontrol_chip(kcontrol);
	struct mt_pcm_dl1_priv *priv = snd_soc_platform_get_drvdata(platform);
...
static int volkey_switch_get(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
...
static int volkey_switch_set(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
...
static const struct soc_enum mt_pcm_dl1_control_enum[] = {
	SOC_ENUM_SINGLE_EXT(ARRAY_SIZE(mt_pcm_dl1_lr_switch_function),
			mt_pcm_dl1_lr_switch_function),
};

static const struct snd_kcontrol_new mt_pcm_dl1_controls[] = {
	SOC_ENUM_EXT("DL1_LR_SWITCH", mt_pcm_dl1_control_enum[0],
		dl1_lr_switch_get, dl1_lr_switch_set),
};

static const struct soc_enum mt_volkey_control_enum[] = {
	SOC_ENUM_SINGLE_EXT(ARRAY_SIZE(mt_volume_key_switch_function),
			mt_volume_key_switch_function),
};

static const struct snd_kcontrol_new mt_volkey_controls[] = {
	SOC_ENUM_EXT("VOLKEY_SWITCH", mt_volkey_control_enum[0],
		volkey_switch_get, volkey_switch_set),
};
...
static int mt_pcm_dl1_probe(struct snd_soc_platform *platform)
{
	...
	snd_soc_add_platform_controls(platform, mt_volkey_controls,
				ARRAY_SIZE(mt_volkey_controls));
	return 0;
}
