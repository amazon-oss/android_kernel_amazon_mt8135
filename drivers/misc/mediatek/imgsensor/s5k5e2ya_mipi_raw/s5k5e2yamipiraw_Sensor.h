...
typedef struct {
	...
	#define S5K5E2YA_PV_PERIOD_LINE_NUMS				(2112)

	/* Video */
	#define S5K5E2YA_VIDEO_PERIOD_PIXEL_NUMS			(2950)
	#define S5K5E2YA_VIDEO_PERIOD_LINE_NUMS				(2112)

	/* Capture */
	#define S5K5E2YA_FULL_PERIOD_PIXEL_NUMS				(2950)
	#define S5K5E2YA_FULL_PERIOD_LINE_NUMS				(2112)
	...
	/*************** +Sensor Output Size ***************/
	#define S5K5E2YA_IMAGE_SENSOR_PV_WIDTH				(2560)
	#define S5K5E2YA_IMAGE_SENSOR_PV_HEIGHT				(1920)

	#define S5K5E2YA_IMAGE_SENSOR_VIDEO_WIDTH			(2560)
	#define S5K5E2YA_IMAGE_SENSOR_VIDEO_HEIGHT			(1920)
...
#define S5K5E2YAMIPI_EEPROM_ID						(0xa0)



#define SENSOR_PCLK_PREVIEW						(187200000)
#define SENSOR_PCLK_VIDEO						(179200000)
...
UINT32 S5K5E2YAMIPIGetInfo(MSDK_SCENARIO_ID_ENUM ScenarioId, MSDK_SENSOR_INFO_STRUCT *pSensorInfo,
				MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData);
UINT32 S5K5E2YAMIPIControl(MSDK_SCENARIO_ID_ENUM ScenarioId, MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *pImageWindow,
				MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData);
...
extern EEPROM_LSC_DATA_T S5K5E2YA_lsc_eeprom_data;

extern kal_uint16 S5K5E2YA_read_eeprom_sensor(kal_uint16 addr);

extern void S5K5E2YA_bytewrite_cmos_sensor(kal_uint32 addr, kal_uint32 para);

extern int S5K5E2YA_get_eeprom_full_data(EEPROM_ALL_DATA_T *fulldata);

extern int S5K5E2YA_get_eeprom_awb_data(EEPROM_AWB_DATA_T *data);

extern int S5K5E2YA_get_eeprom_lsc_data(EEPROM_LSC_DATA_T *lsc_data, int *flag);
