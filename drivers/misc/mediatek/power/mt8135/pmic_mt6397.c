...
static u32 mt6397_get_events_locked(struct mt6397_chip *chip)
{
...
void PMIC_INIT_SETTING_V1(void)
{
	...
	case 0x91:
		...
		/* [8:8]: VCORE_VOSEL_SLEEP; sleep mode only (0.85V) */
		ret = pmic_config_interface(0x27C, 0x18, 0x7F, 0);
		/* [8:8]: VPCA7_VOSEL_SLEEP; sleep mode only (0.85V) */
		ret = pmic_config_interface(0x33C, 0x18, 0x7F, 0);
		/* [8:8]: VSRMCA7_VOSEL_SLEEP; sleep mode only (0.85V) */
		ret = pmic_config_interface(0x362, 0x18, 0x7F, 0);
		/* [8:8]: VCORE_VSLEEP_EN; Sleep mode HW control from R2R DAC */
		ret = pmic_config_interface(0x28A, 0x0, 0x1, 8);
		/* [8:8]: VPCA7_VSLEEP_EN; Sleep mode HW control from R2R DAC */
		ret = pmic_config_interface(0x34A, 0x0, 0x1, 8);
		/* [8:8]: VSRMCA7_VSLEEP_EN; Sleep mode HW control from R2R DAC */
		ret = pmic_config_interface(0x370, 0x0, 0x1, 8);
		break;
	case 0x97:
		/* [7:4]: RG_VCDT_HV_VTH; 7V OVP */
		ret = pmic_config_interface(0x2, 0xB, 0xF, 4);
		/* [11:10]: QI_VCORE_VSLEEP; sleep mode only (0.85V) */
		...
		/* [8:8]: VPCA7_VSLEEP_EN; Sleep mode HW control  R2R to VtoV */
		ret = pmic_config_interface(0x34A, 0x1, 0x1, 8);
		/* [8:8]: VSRMCA7_VSLEEP_EN; Sleep mode HW control  R2R to VtoV */
	...
	ret = pmic_config_interface(0x372, 0x10, 0x7F, 8);	/* [14:8]: VSRMCA7_VOSEL_OFFSET; set offset=100mV */
