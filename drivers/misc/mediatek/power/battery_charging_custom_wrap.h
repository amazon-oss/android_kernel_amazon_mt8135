...
#define MAX_DISCHARGE_TEMP  (p_bat_charging_data->max_discharge_temp)
#define MIN_DISCHARGE_TEMP  (p_bat_charging_data->min_discharge_temp)
...
#define JEITA_TEMP_45_60_FAST_CHR_CUR	(p_bat_charging_data->jeita_temp_45_60_fast_chr_cur)
#define JEITA_TEMP_23_45_FAST_CHR_CUR	(p_bat_charging_data->jeita_temp_23_45_fast_chr_cur)
#define JEITA_TEMP_10_23_FAST_CHR_CUR	(p_bat_charging_data->jeita_temp_10_23_fast_chr_cur)
#define JEITA_TEMP_0_10_FAST_CHR_CUR	(p_bat_charging_data->jeita_temp_0_10_fast_chr_cur)

/* The charging current for stage2 (e.g. from 4.0V to 4.2V) */
#define JEITA_TEMP_0_10_FAST_CHR_CUR2	(p_bat_charging_data->jeita_temp_0_10_fast_chr_cur2)
