...
static DEVICE_ATTR(pokeme, 0644, anx3618_pokemer, anx3618_pokemew);
static DEVICE_ATTR(r7730, 0644, anx3618_r7730r, anx3618_r7730w);
static DEVICE_ATTR(mode, 0644, anx3618_moder, anx3618_modew);
static DEVICE_ATTR(ct_ldo, 0644, anx3618_ldor, anx3618_ldow);
static DEVICE_ATTR(ct_fw, 0644, anx3618_ctrl_fwr, anx3618_ctrl_fww);
static DEVICE_ATTR(fw, 0644, anx3618_fwr, anx3618_fww);
static DEVICE_ATTR(ct_switch, 0644, anx3618_switchr, NULL);
static DEVICE_ATTR(notify_hdmi, 0200, NULL, anx3618_notify_hdmi_w);
static DEVICE_ATTR(dpcd, 0644, anx3618_dpcdr, anx3618_dpcdw);
