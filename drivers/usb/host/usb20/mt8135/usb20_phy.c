...
bool usb_id_pullup_enable(bool enable)
{
}
...
{
	if (enable) {
		/*RG_IDPULLUP=1 force_idpullup=1*/
		USBPHY_SET8(0x6c, 0x01);
		USBPHY_SET8(0x6d, 0x01);
	} else {
		/*RG_IDPULLUP=0 force_idpullup=1*/
		USBPHY_CLR8(0x6c, 0x01);
		USBPHY_SET8(0x6d, 0x01);
	}
	return 1;
}
