...
#define MSDC_IOCON_DSPLSEL      (0x1  << 5)	/* RW */     /* New definition of MSDC_CODA_SD30_v2.13 */
...
struct msdc_host {
	...
	u32 powertimeout_count; /* total power timeout count */
	u32 datatimeout_count; /* total data timeout count */
	u32 pc_count;	/* total power cycle count */
	u32 pc_busy;	/* busy programming count */
	u32 pc_datatimeout;	/* data timeout count */
	u32 pc_crcsdr25;	/* crc count in sdr25 mode */
...
#define DAT_TIMEOUT         (HZ    * 60) /* 1000ms x 60 */
