...
#define BOARD_ID_THEBES_STR "0020"
...
P_COUNTRY_POWER_TABLE wlanGetUpdatedPowerTable(P_UINT_8 paucCountry)
{
	...
	static COUNTRY_POWER_TABLE asCountryPwrTbl_refresh[] = {
			{
				{'U', 'S',}, /*country code*/
				{/*tx power*/
				0x29, 0x29,
				{0x00, 0x00,},
				0x28, 0x28, 0x28, 0x28, 0x28, 0x24,
				0x28, 0x28, 0x28, 0x24, 0x24, 0x24,
				0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			...
			},
			{
				...
				0x25, 0x25,
				{0x00, 0x00,},
				0x29, 0x29, 0x29, 0x29, 0x29, 0x24,
				0x29, 0x29, 0x29, 0x24, 0x24, 0x24,
				0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
				0x1F, 0x1F, 0x1F, 0x1F, 0x1F, 0x1F,
	...
	if (!strncmp(idme_board_id, BOARD_ID_THEBES_STR, strlen(BOARD_ID_THEBES_STR))) {
		if (idme_board_id[7] == '8') {
			country_pwr_tbl = asCountryPwrTbl_refresh;
			DBGLOG(INIT, INFO, ("country_pwr_tbl:asCountryPwrTbl_refresh\n"));
		} else {
			DBGLOG(INIT, INFO, ("country_pwr_tbl:asCountryPwrTbl\n"));
		}
	} else {
		DBGLOG(INIT, INFO, ("country_pwr_tbl:asCountryPwrTbl\n"));
	}
	for (i = 0; i < sizeof (asCountryPwrTbl)/sizeof(COUNTRY_POWER_TABLE); i++)
