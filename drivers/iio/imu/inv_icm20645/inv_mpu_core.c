...
static char accel_bias_set[3] = {0, 0, 0};
		...
		int accel_bias, int axis)
{
	...
	if (accel_bias) {
		if (accel_bias_set[axis] > 0) {
			pr_err("inv_mpu_core : Already set accel factory biases! Axis=%d, Data=%d\n", axis, accel_bias);
			return result;
		} else {
			accel_bias_set[axis] = 1;
		}
	}
...
static IIO_DEVICE_ATTR(in_magn_enable, S_IRUGO | S_IWUSR,
...
static IIO_DEVICE_ATTR(in_6quat_enable, S_IRUGO | S_IWUSR,
		inv_sensor_on_show, inv_sensor_on_store, SENSOR_L_SIXQ);
static IIO_DEVICE_ATTR(in_p6quat_enable, S_IRUGO | S_IWUSR,
...
static IIO_DEVICE_ATTR(in_als_px_enable, S_IRUGO | S_IWUSR,
...
static IIO_DEVICE_ATTR(in_magn_rate, S_IRUGO | S_IWUSR,
...
static IIO_DEVICE_ATTR(in_6quat_rate, S_IRUGO | S_IWUSR,
	inv_sensor_rate_show, inv_sensor_rate_store, SENSOR_L_SIXQ);
static IIO_DEVICE_ATTR(in_p6quat_rate, S_IRUGO | S_IWUSR,
...
static IIO_DEVICE_ATTR(in_als_px_rate, S_IRUGO | S_IWUSR,
...
static IIO_DEVICE_ATTR(debug_gyro_cal_enable, S_IRUGO | S_IWUSR,
	inv_attr_show, inv_debug_attr_store, ATTR_DMP_GYRO_CAL_ENABLE);
static IIO_DEVICE_ATTR(debug_accel_cal_enable, S_IRUGO | S_IWUSR,
...
static IIO_DEVICE_ATTR(debug_dmp_on, S_IRUGO | S_IWUSR,
	inv_attr_show, inv_debug_attr_store, ATTR_DMP_ON);
static IIO_DEVICE_ATTR(debug_dmp_event_int_on, S_IRUGO | S_IWUSR,
	inv_attr_show, inv_debug_attr_store, ATTR_DMP_EVENT_INT_ON);
static IIO_DEVICE_ATTR(debug_mem_read, S_IRUGO | S_IWUSR,
	inv_attr_show, inv_dmp_bias_store, ATTR_DMP_DEBUG_MEM_READ);
static IIO_DEVICE_ATTR(debug_mem_write, S_IRUGO | S_IWUSR,
...
static IIO_DEVICE_ATTR(debug_cfg_write, S_IRUGO | S_IWUSR,
...
static IIO_DEVICE_ATTR(in_activity_enable, S_IRUGO | S_IWUSR,
