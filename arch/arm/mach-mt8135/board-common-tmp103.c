...
static struct mtk_thermal_platform_data tmp103_thermal_data = {
	...
	.trips[0] = {.temp = 42750, .type = THERMAL_TRIP_ACTIVE, .hyst = 0},
	.trips[1] = {.temp = 43000, .type = THERMAL_TRIP_ACTIVE, .hyst = 0},
	.trips[2] = {.temp = 43250, .type = THERMAL_TRIP_ACTIVE, .hyst = 0},
	.trips[3] = {.temp = 43500, .type = THERMAL_TRIP_ACTIVE, .hyst = 0},
	.trips[4] = {.temp = 43750, .type = THERMAL_TRIP_ACTIVE, .hyst = 0},
	.trips[5] = {.temp = 44000, .type = THERMAL_TRIP_ACTIVE, .hyst = 0},
	.trips[6] = {.temp = 45000, .type = THERMAL_TRIP_CRITICAL, .hyst = 0},
