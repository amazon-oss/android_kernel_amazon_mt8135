...
static struct mt_audio_pmic_codec_data audio_pmic_codec_data;
...
static struct platform_device mtk_soc_pmic_codec_device = {
	...
	.id = PLATFORM_DEVID_NONE,
	.dev = {
		.platform_data = &audio_pmic_codec_data,
		},
};
							...
							int mt_audio_board_amp_class_type)
{
	...
	audio_pmic_codec_data.mt_audio_board_amp_class_type = mt_audio_board_amp_class_type;
