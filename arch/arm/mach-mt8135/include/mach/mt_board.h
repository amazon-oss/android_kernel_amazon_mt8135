...
#define BOARD_ID_ALEXANDRIA 			0x0022
#define BOARD_ID_MEMPHIS			0x0021
#define BOARD_ID_THEBES				0x0020
...
/* Thebes */
#define BOARD_REV_THEBES_PREHVT			0x0001
#define BOARD_REV_THEBES_HVT			(BOARD_REV_THEBES_PREHVT+1)
#define BOARD_REV_THEBES_EVT			(BOARD_REV_THEBES_HVT+1)
#define BOARD_REV_THEBES_DVT			(BOARD_REV_THEBES_EVT+1)
#define BOARD_REV_THEBES_PVT			0x0006

/* Thebes Refresh */
#define BOARD_REV_THEBES_REFRESH_EVT		(0x80 | BOARD_REV_THEBES_EVT)
#define BOARD_REV_THEBES_REFRESH_EVT_1_1	(BOARD_REV_THEBES_REFRESH_EVT + 1)
#define BOARD_REV_THEBES_REFRESH_DVT		(BOARD_REV_THEBES_REFRESH_EVT_1_1 + 1)
#define BOARD_REV_THEBES_REFRESH_PVT		(BOARD_REV_THEBES_REFRESH_DVT + 1)

/* Memphis */
#define BOARD_REV_MEMPHIS_HVT			0x0002
#define BOARD_REV_MEMPHIS_EVT			(BOARD_REV_MEMPHIS_HVT+1)
#define BOARD_REV_MEMPHIS_DVT			(BOARD_REV_MEMPHIS_EVT+1)
#define BOARD_REV_MEMPHIS_PVT			0x0006

/* Alexandria */
#define BOARD_REV_ALEXANDRIA_PROTO		0x0001
