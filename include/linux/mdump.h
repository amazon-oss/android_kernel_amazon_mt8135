...
#if defined(CONFIG_MT8135_ARIEL) || defined(CONFIG_MT8135_ASTON) || \
	defined(CONFIG_MT8135_THEBES)
#define COMPRESS_START_ADDRESS	0x8C000000
#endif /* Ariel, Aston, Thebes */
