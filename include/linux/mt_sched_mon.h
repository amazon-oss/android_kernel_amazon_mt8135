...
struct sched_stop_event {
	...
	unsigned long cur_start_addr0;
	unsigned long cur_start_addr1;
	unsigned long start_addr0;
	unsigned long start_addr1;
	unsigned long end_addr0;
	unsigned long end_addr1;
};
...
extern void MT_trace_preempt_on(unsigned long addr0, unsigned long addr1);
extern void MT_trace_preempt_off(unsigned long addr0, unsigned long addr1);
